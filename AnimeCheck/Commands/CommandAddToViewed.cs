...
{
    public class CommandAddToViewed : CommandBase
    {
        public override void Execute(object parameter)
        {
            if (parameter is ViewedViewModel viewedViewModel)
            {
                ...
                {
                    TitleRepo.SwichStatus(viewedViewModel.SelectedPart, Status.Viewed);
            ...
            if (parameter is WatchViewModel watchViewModel)
            {
                ...
                {
                    TitleRepo.SwichStatus(watchViewModel.SelectedPart, Status.Viewed);
            ...
            if (parameter is PlannedViewModel plannedViewModel)
            {
                ...
                {
                    TitleRepo.SwichStatus(plannedViewModel.SelectedPart, Status.Viewed);
